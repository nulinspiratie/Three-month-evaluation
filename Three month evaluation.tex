...
Unless stated otherwise, all measurements were performed with the fridge at base temperature (\SI{~15}{\milli \kelvin}).
...
To further investigate the temperature dependence of the resonator, it has been continuously measured while the fridge was cooling down from \SI{~1}{\kelvin} to base temperature (\SI{15}{\milli \kelvin}).
